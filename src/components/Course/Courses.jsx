  ...
  return (
    <div>
      <div className="container mt-10">
        <div>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center gap-10 mb-24">
            {[
              ...
              <div
                key={index}
                className="course-card flex flex-col gap-8 bg-blue-100 shadow-lg transition-transform duration-300 ease-in-out group w-full lg:w-1/3 overflow-hidden"
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-orange-700 text-2xl font-bold">{course.price}</span>
        ...
        {selectedCourse !== null && (
          <div className="fixed inset-1 bg-gray-500 bg-opacity-50 z-50 flex items-center justify-center p-10 transition-transform ">
            <div className="bg-gray-100 p-6 rounded-lg shadow-lg max-w-2xl w-full">
              <h2 className="text-2xl font-bold mb-4">{courseDetails[selectedCourse].title}</h2>
